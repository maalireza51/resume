'use client'
import { HiUser, HiAcademicCap, HiCog, HiLightBulb, HiGlobeAlt, HiHeart, HiTrophy, HiRocketLaunch } from "react-icons/hi2";
  ...
  const achievements = [
    {
      ...
      description: "Improved system performance by 60% through advanced code optimization and architectural redesigns",
      color: "text-yellow-600 dark:text-yellow-400"
    },
    {
      icon: HiRocketLaunch,
      title: "Team Leadership",
      description: "Successfully led cross-functional teams of 5-8 engineers on multiple high-impact projects",
      color: "text-blue-600 dark:text-blue-400"
    },
    {
      icon: HiLightBulb,
      title: "Innovation Driver",
      description: "Introduced modern development practices that reduced deployment time by 40%",
      color: "text-green-600 dark:text-green-400"
    },
    {
      icon: HiGlobeAlt,
      title: "Global Impact",
      description: "Built scalable solutions serving 100K+ users across multiple countries",
    ...
    >
      ...
      <motion.section variants={itemVariants}>
        <div className="flex items-center border-b-2 border-skin/20 pb-4 mb-6">
          ...
          <h1 className="text-xl font-semibold text-gray-800 dark:text-white">About Me</h1>
        </div>
      </motion.section>

      {/* Professional Summary */}
      <motion.section variants={itemVariants} className="bg-gradient-to-r from-transparent to-gray-500/5 p-6 rounded-2xl">
        ...
        <div className="space-y-4 text-gray-700 dark:text-gray-300">
          <p className="leading-relaxed">
            I'm a passionate <strong className="text-skin">Software Engineer</strong> with over 5 years of experience 
            crafting innovative digital solutions. My journey began with a curiosity about how technology can solve 
            real-world problems, and it has evolved into a deep expertise in building scalable, user-centric applications.
          </p>
          <p className="leading-relaxed">
            Throughout my career, I've had the privilege of working with diverse teams across various industries, 
            from fintech startups to established marketplace platforms. I specialize in full-stack development, 
            system architecture, and team leadership, always focusing on delivering exceptional user experiences 
            while maintaining robust, scalable codebases.
          </p>
          <p className="leading-relaxed">
            My approach combines technical excellence with strategic thinking, ensuring that every solution I build 
            not only meets immediate requirements but also scales gracefully as businesses grow.
          </p>
        </div>
      </motion.section>
          ...
          {achievements.map((achievement, index) => (
            ...
            >
              <div className="flex items-start space-x-4">
                <div className={`p-3 rounded-lg bg-gray-50 dark:bg-neutral-700`}>
